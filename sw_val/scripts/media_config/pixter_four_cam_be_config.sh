...
main() {
    ...
    /home/root/sw_val/bin/media-ctl -v -t "\"Intel IPU4 CSI2 BE SOC\":0(0) => 8(0)[3]"
    /home/root/sw_val/bin/media-ctl -v -t "\"Intel IPU4 CSI2 BE SOC\":1(1) => 9(1)[1]"
    /home/root/sw_val/bin/media-ctl -v -t "\"Intel IPU4 CSI2 BE SOC\":2(2) => 10(2)[1]"
    /home/root/sw_val/bin/media-ctl -v -t "\"Intel IPU4 CSI2 BE SOC\":3(3) => 11(3)[1]"
    ...
    do
        ...
        /home/root/sw_val/bin/media-ctl -v -V "\"Intel IPU4 CSI2 BE SOC\":$j [fmt:${FORMATS[$j]}/${RESOLUTIONS[$j]}]"
        k=`expr $j + 8`
        /home/root/sw_val/bin/media-ctl -v -V "\"Intel IPU4 CSI2 BE SOC\":$k [fmt:${FORMATS[$j]}/${RESOLUTIONS[$j]}]"
        j=$((j+1))
    done
    ...
    /home/root/sw_val/bin/media-ctl -l '"Intel IPU4 CSI-2 0":2 -> "Intel IPU4 CSI2 BE SOC":1[5]'
    /home/root/sw_val/bin/media-ctl -l '"Intel IPU4 CSI2 BE SOC":9 -> "Intel IPU4 BE SOC capture 1":0[5]'

    /home/root/sw_val/bin/media-ctl -l '"Intel IPU4 CSI-2 0":3 -> "Intel IPU4 CSI2 BE SOC":2[5]'
    /home/root/sw_val/bin/media-ctl -l '"Intel IPU4 CSI2 BE SOC":10 -> "Intel IPU4 BE SOC capture 2":0[5]'

    /home/root/sw_val/bin/media-ctl -l '"Intel IPU4 CSI-2 0":4 -> "Intel IPU4 CSI2 BE SOC":3[5]'
    /home/root/sw_val/bin/media-ctl -l '"Intel IPU4 CSI2 BE SOC":11 -> "Intel IPU4 BE SOC capture 3":0[5]'
    ...
    DEV_NAME_3=$(/home/root/sw_val/bin/media-ctl -e "Intel IPU4 BE SOC capture 2")
    DEV_NAME_4=$(/home/root/sw_val/bin/media-ctl -e "Intel IPU4 BE SOC capture 3")
