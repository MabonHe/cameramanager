...
if [ ! -z $(echo $media_config | grep "adv7481_dual") ] ; then
    . /home/root/sw_val/scripts/resolution_list/adv7481_dual.sh
elif [ ! -z $(echo $media_config | grep "adv7481") ] ; then
    . /home/root/sw_val/scripts/resolution_list/adv7481.sh
elif [  ! -z $(echo $media_config | grep "tpg") ] ; then
    . /home/root/sw_val/scripts/resolution_list/tpg.sh
elif [  ! -z $(echo $media_config | grep "imx185") ] ; then
    . /home/root/sw_val/scripts/resolution_list/imx185.sh
fi

function get_info_by_index()
{
    local index=$1
